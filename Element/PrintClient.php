...
class PrintClient extends Element
{
    ...
    {
        return "mb.print.client.class.title";
    }
    ...
    {
        return "mb.print.client.class.description";
    }
    ...
    {
        return array(
            "mb.print.client.tag.print",
            "mb.print.client.tag.pdf",
    ...
    public static function listAssets()
    {
        return array(
            'js'    => array(
                '@MapbenderPrintBundle/Resources/public/mapbender.element.printClient.js',
